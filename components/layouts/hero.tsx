...
const Hero = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 sm:pt-28 pb-12 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          {/* Content Container */}
          <div className="relative p-2 sm:p-4 lg:p-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Left Side - Text Content */}
            <div className="text-center lg:text-left space-y-5" data-aos="fade-right">
              {/* Badge/Tag */}
              <div className="inline-block">
                <span className="px-3 py-1.5 bg-slate-900/10 text-slate-700 dark:bg-white/10 dark:text-white rounded-full text-xs sm:text-sm font-medium transition-colors duration-300">
                  Open for Projects
                </span>
              </div>
              ...
              {/* Description */}
              <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-gray-300 font-light transition-colors duration-300">
                Developer who obsesses over performance & user experience
              </p>
              <p className="text-slate-500 dark:text-gray-400 text-sm sm:text-base max-w-lg mx-auto lg:mx-0 transition-colors duration-300">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-2">
                <a
                  href="/cv.pdf"
                  download
                  className="group px-6 py-3 bg-gradient-to-r from-blue-400 via-purple-500 to-violet-400 text-white rounded-lg text-sm font-semibold hover:from-blue-500 hover:via-purple-600 hover:to-violet-500 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/30 text-center"
                >
                ...
                <button
                  ...
                  className="group px-6 py-3 bg-transparent text-slate-900 dark:text-white rounded-lg text-sm font-semibold hover:bg-slate-900/10 dark:hover:bg-white/10 transition-all duration-300 text-center"
                >
                  <span className="flex items-center justify-center gap-2">
                    Contact Me
            ...
            <div className="relative flex items-center justify-center" data-aos="fade-left">
              <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64">
                {/* Hero Image */}
                <div className="relative w-full h-full rounded-full overflow-hidden shadow-lg shadow-slate-900/10 dark:shadow-white/10 z-20 transition-shadow duration-300">
                  <Image
                    src="/hero-image.png"
                ...
                <div className="floating-logo logo-1 z-30">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-gray-900 rounded-lg flex items-center justify-center shadow-lg p-2">
                ...
                <div className="floating-logo logo-2 z-30">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-black rounded-lg flex items-center justify-center shadow-lg p-1.5">
                ...
                <div className="floating-logo logo-4 z-30">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-600 rounded-lg flex items-center justify-center shadow-lg p-2">
                ...
                <div className="floating-logo logo-5 z-30">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#303030] rounded-lg flex items-center justify-center shadow-lg p-1.5">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-1/4 left-10 w-2 h-2 bg-slate-900/30 dark:bg-white/30 rounded-full animate-pulse transition-colors duration-300"></div>
        <div className="absolute top-1/3 right-20 w-3 h-3 bg-slate-900/20 dark:bg-white/20 rounded-full animate-pulse delay-100 transition-colors duration-300"></div>
        <div className="absolute bottom-1/4 left-1/4 w-2 h-2 bg-slate-900/20 dark:bg-white/20 rounded-full animate-pulse delay-200 transition-colors duration-300"></div>
      </section>

      {/* Email Contact Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 dark:bg-black/80 backdrop-blur-sm" onClick={() => setIsModalOpen(false)}>
          <div className="relative w-full max-w-md bg-white dark:bg-black rounded-2xl p-8 shadow-2xl transition-colors duration-300" onClick={(e) => e.stopPropagation()}>
            {/* Close Button */}
            <button
              onClick={() => setIsModalOpen(false)}
              className="absolute top-4 right-4 text-slate-400 hover:text-slate-900 dark:text-gray-400 dark:hover:text-white transition-colors"
            >
            ...
            {/* Modal Header */}
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 transition-colors duration-300">Get in Touch</h2>
            <p className="text-slate-500 dark:text-gray-400 mb-6 transition-colors duration-300">Send me a message and I&apos;ll get back to you soon!</p>

            {/* Contact Form */}
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-slate-600 dark:text-gray-300 mb-2 transition-colors duration-300">Name</label>
                <input
                  type="text"
                  id="name"
                  required
                  ...
                  className="w-full px-4 py-3 bg-slate-100 dark:bg-white/5 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-slate-300 dark:focus:ring-white/30 transition-colors"
                  placeholder="Your name"
                />
              </div>

              <div>
                <label htmlFor="email" className="block text-sm font-medium text-slate-600 dark:text-gray-300 mb-2 transition-colors duration-300">Email</label>
                <input
                  type="email"
                  id="email"
                  required
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-slate-600 dark:text-gray-300 mb-2 transition-colors duration-300">Message</label>
                <textarea
                  id="message"
                  required
                  rows={4}
                  ...
                  className="w-full px-4 py-3 bg-slate-100 dark:bg-white/5 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-slate-300 dark:focus:ring-white/30 transition-colors resize-none"
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-slate-900 text-white dark:bg-white dark:text-black rounded-lg font-semibold hover:bg-slate-800 dark:hover:bg-gray-200 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed min-h-[48px] flex items-center justify-center"
              >
