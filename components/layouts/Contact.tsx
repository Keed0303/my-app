          ...
          >
            ...
            <div className="mt-8 pt-8 border-t border-blue-500/30">
              <div className="flex justify-center gap-6">
                <a href="https://github.com/Keed0303" className="text-gray-400 hover:text-blue-400 transition-colors">
                ...
                <a href="https://www.linkedin.com/in/monagpala/" className="text-gray-400 hover:text-blue-400 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
